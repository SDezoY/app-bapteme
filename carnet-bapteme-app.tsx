            ...
            <div className="overflow-y-auto max-h-[70vh] p-6">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-purple-50 p-6 rounded-lg">
                  ...
                  {formData.confessions?.map((confession, index) => (
                    <div key={confession.id} className="bg-white p-4 rounded-lg mb-3 border">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <input
                          type="number"
                          placeholder="Année"
                          value={confession.annee}
                          onChange={(e) => {
                            const newConfessions = [...formData.confessions];
                            newConfessions[index].annee = e.target.value;
                            setFormData({...formData, confessions: newConfessions});
                          }}
                        ...
                        <input
                          type="date"
                          placeholder="Date"
                          value={confession.date}
                          onChange={(e) => {
                            const newConfessions = [...formData.confessions];
                            newConfessions[index].date = e.target.value;
                            setFormData({...formData, confessions: newConfessions});
                          }}
                          className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                          disabled={modalType === 'consulter'}
                        ...
                        <input
                          type="text"
                          placeholder="Prêtre"
                          value={confession.pretre}
                          onChange={(e) => {
                            const newConfessions = [...formData.confessions];
                            newConfessions[index].pretre = e.target.value;
                            setFormData({...formData, confessions: newConfessions});
                          }}
                          className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                          disabled={modalType === 'consulter'}
